...
set.seed(123456789)
knitr::opts_chunk$set(message = FALSE, warnings = FALSE, fig.align="center")
@
...
<<eval=(require(udpipe) && require(ggraph) && require(ggplot2) && require(igraph)), fig.width=10, fig.height=5>>=
library(textplot)
library(udpipe)
library(ggraph)
library(ggplot2)
...
<<eval=(require(udpipe) && require(ggraph) && require(ggplot2) && require(igraph)), fig.width=12, fig.height=6, out.width = '1\\textwidth', out.height = '0.5\\textwidth'>>=
...
<<eval=(require(BTM) && require(ggraph) && require(ggforce) && require(concaveman) && require(igraph)), fig.width=8, fig.height=6, out.width = '\\textwidth'>>=
library(BTM)
library(ggraph)
library(ggforce)
library(concaveman)
...
\newpage
<<eval=(require(BTM) && require(ggraph) && require(ggforce) && require(concaveman) && require(igraph)), fig.width=8, fig.height=6>>=
...
<<eval=(require(BTM) && require(ggraph) && require(ggforce) && require(concaveman) && require(igraph) && require(data.table) && require(udpipe)), results="hide", fig.width=8, fig.height=6>>=
library(BTM)
library(ggraph)
library(ggforce)
library(concaveman)
...
<<eval=(require(BTM) && require(ggraph) && require(ggforce) && require(concaveman) && require(igraph) && require(data.table) && require(udpipe)), fig.width=8, fig.height=8>>=
library(BTM)
library(ggraph)
library(ggforce)
library(concaveman)
...
<<eval=(require(Rgraphviz) && require(udpipe) && require(graph)), fig.width=5, fig.height=5>>=
library(graph)
library(Rgraphviz)
library(udpipe)
...
<<eval=(require(udpipe) && require(qgraph) && require(glasso)), fig.width=6, fig.height=6>>=
library(glasso)
library(qgraph)
library(udpipe)
...
<<eval=(require(udpipe) && require(igraph) && require(ggraph) && require(ggplot2)), fig.width=6, fig.height=6, out.width = '0.75\\textwidth', out.height = '0.75\\textwidth'>>=
library(udpipe)
library(igraph)
library(ggraph)
library(ggplot2)
...
<<eval=(require(udpipe) && require(igraph) && require(ggraph) && require(ggplot2) && require(data.table)), fig.width=8, fig.height=6, out.width = '0.8\\textwidth', out.height = '0.6\\textwidth'>>=
library(udpipe)
library(igraph)
library(ggraph)
library(ggplot2)
